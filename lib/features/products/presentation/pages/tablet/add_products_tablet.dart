...
class AddProductScreenTablet extends StatefulWidget {
  const AddProductScreenTablet({super.key});

  @override
  State<AddProductScreenTablet> createState() => _AddProductScreenTabletState();
}

class _AddProductScreenTabletState extends State<AddProductScreenTablet> {
  List<File> _images = [];
