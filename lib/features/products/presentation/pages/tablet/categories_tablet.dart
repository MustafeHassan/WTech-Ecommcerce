...
class CategoriesScreenTablet extends StatefulWidget {
  const CategoriesScreenTablet({super.key});

  @override
  State<CategoriesScreenTablet> createState() => _CategoriesScreenTabletState();
}

class _CategoriesScreenTabletState extends State<CategoriesScreenTablet> {
                          ...
                          children: [
                            ...
                            Visibility(
                              ...
                              child: ImageViewer(
                                ...
                                zoom: () {
                                  zoomImage(context, 0, null, _categoryImage);
                                },
            ...
            MainContainer(
              ...
              child: StatefulBuilder(builder: (context, setState) {
                return const CategoryDataTable(
                  showCheckBox: true,
                  columns: ['ID', 'Name', 'Description', 'Orders', 'Action'],
                  rows: [],
                );
              }),
            ),
