...
import '../../widgets/dashboard_card_tablet.dart';
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Expanded(
                            flex: 4,
                            child: CircleChart(
                                chartData: DashboardPageTablet._chartData),
                          ),
                        ],
                      ),
                    ],
                  ...
                  children: [
                    ...
                    Row(
                      children: <Widget>[
                        Expanded(
                          flex: 4,
                          child: ChartColumn(chartDataColumn: _chartDataColumn),
                        ),
                        Expanded(
                          flex: 4,
                          child: CircleChart(
