...
class CustomersPageMobile extends StatefulWidget {
  const CustomersPageMobile({super.key});

  @override
  State<CustomersPageMobile> createState() => _CustomersPageMobileState();
}

class _CustomersPageMobileState extends State<CustomersPageMobile> {
