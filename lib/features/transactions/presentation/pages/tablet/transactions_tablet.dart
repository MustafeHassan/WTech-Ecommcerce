...
class TransactionsPageTablet extends StatefulWidget {
  const TransactionsPageTablet({super.key});

  @override
  State<TransactionsPageTablet> createState() => _TransactionsPageTabletState();
}

class _TransactionsPageTabletState extends State<TransactionsPageTablet> {
