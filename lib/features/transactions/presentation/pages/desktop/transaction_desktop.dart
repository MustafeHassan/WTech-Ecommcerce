...
class TransactionsPageDesktop extends StatefulWidget {
  const TransactionsPageDesktop({super.key});

  @override
  State<TransactionsPageDesktop> createState() =>
      _TransactionsPageDesktopState();
}

class _TransactionsPageDesktopState extends State<TransactionsPageDesktop> {
